...
public class UserController {
    ...
    @PostMapping("/{userId}")
    public ResponseEntity<?> updateUser(@PathVariable Long id, @RequestBody User updatUser) throws UserNotFoundException {
        User updatedUser = this.userService.updateUser(id, updatUser);
